...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
     ...
     * 短链接访问IP统计
     * */
    @Insert("INSERT INTO t_link_access_logs (full_short_url, gid, user, browser, os, ip, network, device, locale, create_time, update_time, del_flag) " +
            "VALUES( #{linkAccessLogs.fullShortUrl}, #{linkAccessLogs.gid}, #{linkAccessLogs.user}," +
            "#{linkAccessLogs.browser}, #{linkAccessLogs.os}, #{linkAccessLogs.ip}, " +
            "#{linkAccessLogs.network}, #{linkAccessLogs.device}, #{linkAccessLogs.locale}," +
            "NOW(), NOW(), 0);")
