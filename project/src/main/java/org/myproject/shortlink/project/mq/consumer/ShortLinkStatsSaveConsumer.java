...
package org.myproject.shortlink.project.mq.consumer;
...
import org.myproject.shortlink.project.mq.idempotent.MessageQueueIdempotentHandler;
import org.myproject.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
...
import static org.myproject.shortlink.project.common.constant.RedisKeyConstant.LOCK_GID_UPDATE_KEY;
...
public class ShortLinkStatsSaveConsumer implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    public void actualSaveShortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            String actualProvince = "unknow";
            String actualCity = "unknow";
            if (StrUtil.isNotBlank(infoCode) && StrUtil.equals(infoCode, "10000")) {
                ...
                LinkLocaleStatsDO linkLocaleStatsDO = LinkLocaleStatsDO.builder()
                        ...
                        .adcode(unknownFlag ? "unknow" : localeResultObj.getString("adcode"))
                        .cnt(1)
                        .fullShortUrl(fullShortUrl)
                        .country("China")
                        .gid(gid)
