...
import org.myproject.shortlink.admin.remote.dto.resp.*;
 ...
 * 短链接中台远程调用服务
 */
@FeignClient(value = "short-link-project", url = "127.0.0.1:8001")
public interface ShortLinkActualRemoteService {
    ...
    Result<List<ShortLinkGroupCountResqDTO>> listGroupShortLinkCount(@RequestParam("requestParam") List<String> requestParam);
    ...
    Result<Void> saveRecycleBin(@RequestBody RecycleBinReqDTO requestParam);
